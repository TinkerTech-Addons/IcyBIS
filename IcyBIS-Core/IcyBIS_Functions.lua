...
function ns.loadItemLists()
    ...
    if localizedClass == "Death Knight" then
        buildTrackedItems(1, BLOOD_DEATH_KNIGHT_OVERALL_BIS, BLOOD_DEATH_KNIGHT_RAID_BIS,
            BLOOD_DEATH_KNIGHT_MYTHIC_PLUS_BIS)
        buildTrackedItems(2, FROST_DEATH_KNIGHT_OVERALL_BIS, FROST_DEATH_KNIGHT_RAID_BIS,
            FROST_DEATH_KNIGHT_MYTHIC_PLUS_BIS)
        buildTrackedItems(3, UNHOLY_DEATH_KNIGHT_OVERALL_BIS, UNHOLY_DEATH_KNIGHT_RAID_BIS,
            UNHOLY_DEATH_KNIGHT_MYTHIC_PLUS_BIS)
    elseif localizedClass == "Demon Hunter" then
        buildTrackedItems(1, HAVOC_DEMON_HUNTER_OVERALL_BIS, HAVOC_DEMON_HUNTER_RAID_BIS,
            HAVOC_DEMON_HUNTER_MYTHIC_PLUS_BIS)
        buildTrackedItems(2, VENGEANCE_DEMON_HUNTER_OVERALL_BIS, VENGEANCE_DEMON_HUNTER_RAID_BIS,
    ...
    elseif localizedClass == "Evoker" then
        buildTrackedItems(1, DEVASTATION_EVOKER_OVERALL_BIS, DEVASTATION_EVOKER_RAID_BIS,
            DEVASTATION_EVOKER_MYTHIC_PLUS_BIS)
        buildTrackedItems(2, PRESERVATION_EVOKER_OVERALL_BIS, PRESERVATION_EVOKER_RAID_BIS,
            PRESERVATION_EVOKER_MYTHIC_PLUS_BIS)
        buildTrackedItems(3, AUGMENTATION_EVOKER_OVERALL_BIS, AUGMENTATION_EVOKER_RAID_BIS,
            AUGMENTATION_EVOKER_MYTHIC_PLUS_BIS)
    elseif localizedClass == "Hunter" then
        buildTrackedItems(1, BEAST_MASTERY_HUNTER_OVERALL_BIS, BEAST_MASTERY_HUNTER_RAID_BIS,
            BEAST_MASTERY_HUNTER_MYTHIC_PLUS_BIS)
        buildTrackedItems(2, MARKSMANSHIP_HUNTER_OVERALL_BIS, MARKSMANSHIP_HUNTER_RAID_BIS,
    ...
    elseif localizedClass == "Paladin" then
        ...
        buildTrackedItems(2, PROTECTION_PALADIN_OVERALL_BIS, PROTECTION_PALADIN_RAID_BIS,
            PROTECTION_PALADIN_MYTHIC_PLUS_BIS)
        buildTrackedItems(3, RETRIBUTION_PALADIN_OVERALL_BIS, RETRIBUTION_PALADIN_RAID_BIS,
    ...
    elseif localizedClass == "Rogue" then
        buildTrackedItems(1, ASSASSINATION_ROGUE_OVERALL_BIS, ASSASSINATION_ROGUE_RAID_BIS,
    ...
    elseif localizedClass == "Shaman" then
        ...
        buildTrackedItems(2, ENHANCEMENT_SHAMAN_OVERALL_BIS, ENHANCEMENT_SHAMAN_RAID_BIS,
            ENHANCEMENT_SHAMAN_MYTHIC_PLUS_BIS)
        buildTrackedItems(3, RESTORATION_SHAMAN_OVERALL_BIS, RESTORATION_SHAMAN_RAID_BIS,
            RESTORATION_SHAMAN_MYTHIC_PLUS_BIS)
    elseif localizedClass == "Warlock" then
        buildTrackedItems(1, AFFLICTION_WARLOCK_OVERALL_BIS, AFFLICTION_WARLOCK_RAID_BIS,
            AFFLICTION_WARLOCK_MYTHIC_PLUS_BIS)
        buildTrackedItems(2, DEMONOLOGY_WARLOCK_OVERALL_BIS, DEMONOLOGY_WARLOCK_RAID_BIS,
            DEMONOLOGY_WARLOCK_MYTHIC_PLUS_BIS)
        buildTrackedItems(3, DESTRUCTION_WARLOCK_OVERALL_BIS, DESTRUCTION_WARLOCK_RAID_BIS,
    ...
    elseif localizedClass == "Warrior" then
        ...
        buildTrackedItems(3, PROTECTION_WARRIOR_OVERALL_BIS, PROTECTION_WARRIOR_RAID_BIS,
