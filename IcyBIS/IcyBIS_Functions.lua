...
function ns.loadItemLists()
    ...
    elseif localizedClass == "Evoker" then
        buildTrackedItems(1, DEVASTATION_EVOKER_OVERALL_BIS, DEVASTATION_EVOKER_RAID_BIS, DEVASTATION_EVOKER_MYTHIC_PLUS_BIS)
        buildTrackedItems(2, PRESERVATION_EVOKER_OVERALL_BIS, PRESERVATION_EVOKER_RAID_BIS, PRESERVATION_EVOKER_MYTHIC_PLUS_BIS)
        buildTrackedItems(3, AUGMENTATION_EVOKER_OVERALL_BIS, AUGMENTATION_EVOKER_RAID_BIS, AUGMENTATION_EVOKER_MYTHIC_PLUS_BIS)
